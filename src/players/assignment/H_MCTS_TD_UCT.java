...
public class H_MCTS_TD_UCT {
    ...
    private double discountFactor = 0.5; // range(0-1) lower the importance of future factor
    private double stepRate = 0.03; // range(0-1)
    private double decayRate = 0.3; // range(0-1)
