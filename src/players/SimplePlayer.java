    ...
    public Types.ACTIONS act(GameState gs) {
        ...
        if(!unsafeDirections.isEmpty()){
            ...
            if(!directions.isEmpty()) {
                ArrayList<Types.DIRECTIONS> actionsList = directions;
                double maxQ = Double.NEGATIVE_INFINITY;
                Types.DIRECTIONS bestAction = null;
                for (Types.DIRECTIONS act : actionsList) {
                    GameState gsCopy = gs.copy();
                    rollRnd(gsCopy, directionToAction(act));
                ...
                return directionToAction(bestAction);
            }
            else {
