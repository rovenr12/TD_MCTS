...
public class GameView extends JComponent {
    ...
    GameView(TILETYPE[][] objects, int cellSize)
    {
        ...
        backgroundImg = TILETYPE.PASSAGE.getImage();
    }
     ...
     */
    void paint(TILETYPE[][] objects, int[][] bombLife)
    {
        copyObjects(objects, bombLife);
        this.repaint();
    }

    private void copyObjects(TILETYPE[][] objects, int[][] bombs)
    {
        objs = new TILETYPE[gridSize][gridSize];
    ...
    {
        TILETYPE[][] gobj = new TILETYPE[4][4];

        //gobj[0][0] = new GameObject();
        gobj[0][1] = TILETYPE.PASSAGE;
        gobj[0][2] = TILETYPE.PASSAGE;
        gobj[0][3] = TILETYPE.PASSAGE;

        gobj[1][0] = TILETYPE.BOMB;
        gobj[1][1] = TILETYPE.FLAMES;
        gobj[1][2] = TILETYPE.WOOD;
        gobj[1][3] = TILETYPE.RIGID;

        gobj[2][0] = TILETYPE.EXTRABOMB;
        gobj[2][1] = TILETYPE.INCRRANGE;
        gobj[2][2] = TILETYPE.KICK;
        gobj[2][3] = TILETYPE.PASSAGE;

        gobj[3][0] = TILETYPE.AGENT0;
        gobj[3][1] = TILETYPE.AGENT1;
        gobj[3][2] = TILETYPE.AGENT2;
        gobj[3][3] = TILETYPE.AGENT3;
