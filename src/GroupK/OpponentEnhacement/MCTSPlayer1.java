...
public class MCTSPlayer1 extends ParameterizedPlayer {
    ...
    public MCTSPlayer1(long seed, int id) {
        this(seed, id, new MCTSParams());
    }

    public MCTSPlayer1(long seed, int id, MCTSParams params) {
    ...
    @Override
    public Player copy() {
        return new MCTSPlayer1(seed, playerID, params);
    }
}