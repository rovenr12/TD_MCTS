import core.Game;
import players.*;
import players.assignment.H_MCTSPlayer_TDUCT;
import players.mcts.MCTSParams;
import players.mcts.MCTSPlayer;
import players.mcts.MCTSPlayer1;
...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        //default
        if(args.length == 0)
            //args = new String[]{"0", "5", "10", "-1", "6", "5", "6", "5"};
            args = new String[]{"0", "5", "10", "-1", "5", "6", "5", "6"};
        ...
        try {
            ...
            if (S == -1)
            {
                ...
                seeds = new long[] {26456, 6883, 56352, 65105, 55636};
            }else
            {
                if(S <= 0)
                    S = 1;
